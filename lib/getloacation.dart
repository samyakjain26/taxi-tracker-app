...
class _LocationPageState extends State<LocationPage> {
  ...
  Widget build(BuildContext context) {
    return Text(
        '${totalDistance != null ? totalDistance > 1000 ? (totalDistance / 1000).toStringAsFixed(2) : totalDistance.toStringAsFixed(2) : 0} ${totalDistance != null ? totalDistance > 1000 ? 'KM' : 'meters' : 0}');
  }
}
